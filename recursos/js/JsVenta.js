    ...
    switch (value) {
        case 1:
            if (document.getElementById('cod_cliente').value.trim() === "") {
                alert('Primero debe de selecionar un Cliente');
            } else {
                CrearFactura();
            }
            break;
...
function botonerror(){
 //(document.getElementById('cant_producto').alert('No debe contener coma')
    };
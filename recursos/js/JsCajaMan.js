...
function agregar(){
 var xhr = new XMLHttpRequest(),
         ...
         datos ={
        Bandera : 1,
        id_caja: ( document.getElementById('id_caja').value === '' ? 0 : document.getElementById('id_caja').value),
...
function eliminar(id, nombre) {
    document.getElementById("id_caja").value = id;
...
function validacionBtn(value){
    switch (value) {
        ...
        break;
        case 2://es eliminar
        if(document.getElementById('id_caja').value.trim()===""){
        alert("Primero selecciona un registro");    
        }else{
        eliminar(document.getElementById('id_caja').value.trim(),document.getElementById('Descripcion').value.trim()); 
       // alert("Eliminado");
        limpiar();
        }       
            break;
